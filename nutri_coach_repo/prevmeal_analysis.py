...
print(output_prevmeal["meal_quantity"])
print(output_prevmeal["meal_calories"])
print(output_prevmeal["meal_macros_grams"])
print(output_prevmeal["meal_macros_perc"])
print(output_prevmeal["meal_micros"])
print(output_prevmeal["meal_benefits"])
